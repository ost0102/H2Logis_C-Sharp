    ...
    for (i = 0; i < d.length; i++) {
      ...
      if ($$.isStanfordGraphType()) {
        ...
        if (!text) {
            ...
            if (d[i].index == "2") {
                text = "<table class='" + $$.CLASS.tooltip + "'>" + (title || title === 0 ? "<tr><th colspan='2' style='background-color: #009954;'>" + title + "</th></tr>" : "");
            }
            else {
      ...
      /*twkim 마지막에 있는 얘만 색깔 변경 (index는 하드코딩) */
        //if (d[i].index == "0") {
        //    text += "<td class='name'><span style='background-color:#d2d2d2'></span>" + name + "</td>";
        //} else if (d[i].index == "1") {
        //    text += "<td class='name'><span style='background-color:#000'></span>" + name + "</td>";
        //}else if (d[i].index == "2") {
        //    text += "<td class='name'><span style='background-color:#9a9a9a'></span>" + name + "</td>";
        //} 
